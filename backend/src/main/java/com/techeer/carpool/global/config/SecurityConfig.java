    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/posts/mine").authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/posts", "/api/v1/posts/*", "/api/v1/discovery/posts").permitAll()
                ...
                .addFilterBefore(new JwtAuthenticationFilter(jwtTokenProvider, blacklistRedisRepository, members),
